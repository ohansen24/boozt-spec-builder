"""SFCC/SFRA platform adapter, config-driven per brand (build kit 6.3).

Everything storefront-specific lives in brands.yaml: controller_base,
region fallbacks (us_fallback), archive_fallback, shade formatting. NARS is
an instance of this adapter; a new SFCC brand whose storefront matches the
SFRA conventions is YAML-only. Live-captured architecture notes below.
